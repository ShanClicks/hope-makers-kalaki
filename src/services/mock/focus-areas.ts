...
export const FOCUS_AREAS: FocusArea[] = [
  {
    ...
    description:
      "Education is the clearest way out of the cycle Kalaki has lived with for years, and we meet learners at every point where that path is at risk. We support them with school resources, health education, stay-in-school campaigns, mentorship programs, and scholarships. We provide school supplies and materials that remove basic barriers to attending class, alongside in-school health education, including menstrual hygiene support, that keeps pupils healthy and present. Our stay-in-school campaigns take on the region's leading causes of dropout head-on: early pregnancy, early marriage, and the poverty pressures that push families to pull children out. Through mentorship, we connect pupils with people who model a path all the way through to completion, and through scholarships, we offer direct support to learners at risk of dropping out over school fees.",
    icon: "BookOpen",
